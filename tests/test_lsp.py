...
from openquant.services.lsp import is_lsp_update_available, _compare_versions
...
class TestLspUpdateAvailable:
    ...
    @patch('openquant.services.lsp._get_lsp_version')
    ...
    @patch('openquant.services.lsp.requests.get')
    @patch('openquant.services.lsp._get_lsp_version')
