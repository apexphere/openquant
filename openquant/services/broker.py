...
from openquant.exceptions import OrderNotAllowed, InvalidStrategy
...
class Broker:
    def __init__(self, position: Position, exchange: str, symbol: str, timeframe: str) -> None:
        ...
        from openquant.services.api import api
        self.api = api

    @staticmethod
    def _validate_qty(qty: float) -> None:
        if qty == 0:
            raise InvalidStrategy('qty cannot be 0. \nRead more: https://openquant.trade/help/faq/i-keep-getting-invalidstrategy')
