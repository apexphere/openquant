...
from openquant import factories
import openquant.helpers as jh
from openquant.services.candle_service import get_candles_from_db as _get_candles
...
def store_candles(candles: np.ndarray, exchange: str, symbol: str) -> None:
    ...
    """
    from openquant.modes.import_candles_mode import store_candles_list as store_candles_from_list
    import openquant.helpers as jh
