...
from openquant.repositories import candle_repository
from openquant.services import auth as authenticator
from openquant.services.multiprocessing import process_manager
from openquant.services.web import ImportCandlesRequestJson, CancelRequestJson, GetCandlesRequestJson, DeleteCandlesRequestJson
...
def import_candles(request_json: ImportCandlesRequestJson, authorization: Optional[str] = Header(None)) -> JSONResponse:
    ...
    from openquant.modes import import_candles_mode
...
def clear_candles_database_cache(authorization: Optional[str] = Header(None)):
    ...
    from openquant.services.cache import cache
    cache.flush()
...
def get_candles(json_request: GetCandlesRequestJson, authorization: Optional[str] = Header(None)) -> JSONResponse:
    ...
    from openquant.modes.data_provider import get_candles as gc
