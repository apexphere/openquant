...
from openquant.services.web import OptimizationRequestJson, CancelRequestJson, UpdateOptimizationSessionStateRequestJson, UpdateOptimizationSessionStatusRequestJson, TerminateOptimizationRequestJson, UpdateOptimizationSessionNotesRequestJson, GetOptimizationSessionsRequestJson
from openquant import helpers as jh
from openquant.models.OptimizationSession import get_optimization_sessions as get_sessions, update_optimization_session_state, update_optimization_session_status, delete_optimization_session, reset_optimization_session, update_optimization_session_notes, purge_optimization_sessions, get_running_optimization_session_id
from openquant.services.transformers import get_optimization_session, get_optimization_session_for_load_more
from openquant.models.OptimizationSession import get_optimization_session_by_id as get_optimization_session_by_id_from_db
from openquant.modes.optimize_mode import run as run_optimization
...
def download_optimization_log(token: str = Query(...)):
    ...
    from openquant.modes import data_provider
