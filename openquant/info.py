from openquant.enums import exchanges as exchanges_enums, timeframes
from openquant.services.env import ENV_VALUES, is_dev_env
...
if is_dev_env():
    ...
    JESSE_API_URL = 'https://api1.openquant.trade/api'
    JESSE_API2_URL = 'https://api2.openquant.trade'
    JESSE_WEBSITE_URL = 'https://openquant.trade'
...
exchange_info = {
    ...
    exchanges_enums.BYBIT_SPOT: {
        ...
        "url": "https://openquant.trade/bybit",
        "fee": 0.001,
        "type": "spot",
        "supported_leverage_modes": ["cross", "isolated"],
        "supported_timeframes": BYBIT_TIMEFRAMES,
    ...
    exchanges_enums.GATE_USDT_PERPETUAL: {
        ...
        "url": "https://openquant.trade/gate",
        "fee": 0.0005,
        "type": "futures",
        "supported_leverage_modes": ["cross", "isolated"],
