...
import openquant.services.metrics as stats
from openquant import exceptions
from openquant.config import config
from openquant.enums import timeframes, order_types
from openquant.models import Order, Position
from openquant.modes.utils import save_daily_portfolio_balance
from openquant.candle_pipelines import BaseCandlesPipeline
from openquant.routes import router
from openquant.services import charts
from openquant.services import report
from openquant.services import candle_service
from openquant.services.file import store_logs
from openquant.services.validators import validate_routes
from openquant.store import store
from openquant.services import logger
from openquant.services.failure import register_custom_exception_handler
from openquant.services.redis import sync_publish, is_process_active
from openquant.services import order_service
from timeloop import Timeloop
from datetime import timedelta
from openquant.services.progressbar import Progressbar
from openquant.constants import TIMEFRAME_TO_ONE_MINUTES
from openquant.services import candle_service, order_service, position_service, exchange_service
...
def _execute_backtest(
    ...
    """
    from openquant.config import set_config
    ...
    for r in router.routes:
        ...
        try:
            ...
            raise exceptions.InvalidStrategy(
                ...
                "go_long(), etc. For working examples, visit: https://openquant.trade/strategies"
            )
        except:
            raise
